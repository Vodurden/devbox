...
`dotspacemacs/user-config' first."
  ;; Force melpa-stable on ensime. Should be fixed in a later spacemacs version [Date: 2016-07-15]
...
you should place your code here."
  ...
  (add-hook 'scala-mode-hook (lambda() (require 'ensime)))

  ;; Workaround for https://github.com/syl20bnr/spacemacs/issues/7144
  (spacemacs/set-leader-keys-for-minor-mode 'ensime-mode
